...
Constraint: only send to addresses that completed **double opt-in** (current
...
1. **Add your experience** — type it, import your PDF/DOCX, or start from the
   example resume: https://cv.zalize.com/builder
2. **Tailor it to the job** — paste the posting for a free ATS match score,
   then let AI Tailor suggest per-bullet rewrites (you approve each one).
3. **Download** — real text PDF or DOCX, no watermark. Free during beta.

One promise worth repeating: your resume lives in your browser, not our
database, and our AI never invents facts about you.
...
**Subject:** The 5-minute ATS check most applications skip

Most rejections aren't the ATS "blocking" you — they're a resume that doesn't
echo the posting's actual keywords. Paste the job description into the free
checker and you'll see, highlighted in the posting itself, which required
terms your resume covers and which it's missing:
...
What stays free forever: the full editor, all 22 templates, the live preview,
and the unlimited ATS checker. What never happens: subscriptions,
auto-renewals, stored cards, "cancel by phone" mazes.
