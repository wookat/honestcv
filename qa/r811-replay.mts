// R811: replay the 186 retained texts against the frozen R810 parser (/home/ubuntu/qa/r811-wt)
// and print every difference.
// Run: npx vite-node qa/r811-replay.mts
import { readFileSync } from 'node:fs'
import { parseResumeText } from '../src/lib/importText'
import { parseResumeText as parseOld } from '../../../qa/r811-wt/src/lib/importText'
